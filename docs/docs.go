...
// 2020-12-28 18:11:22.62341848 +0800 CST m=+0.105761098
    ...
    "definitions": {
        ...
        "applications.CreateAppRequest": {
            ...
            "properties": {
                "context": {
                    "type": "string",
                    "example": "{\"application_url\":\"git@github.com:nocalhost/bookinfo.git\",\"application_name\":\"name\",\"source\":\"git/helm_repo\",\"install_type\":\"rawManifest/helm_chart\",\"resource_dir\":[\"manifest/templates\"],\"nocalhost_config\":\"base64encode(config_templates)\"}"
                },
                "status": {
                    "type": "integer"
                }
