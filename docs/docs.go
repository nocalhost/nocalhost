...
// 2021-12-15 11:23:39.014472 +0800 CST m=+0.242916558
...
var doc = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/setupcluster.MeshDevInfo"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "setupcluster.MeshDevApp": {
            ...
            "properties": {
                ...
                "workloads": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/setupcluster.MeshDevWorkload"
                    }
                }
            }
        },
        "setupcluster.MeshDevInfo": {
            ...
            "properties": {
                "apps": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/setupcluster.MeshDevApp"
                    }
                },
                "header": {
                    "type": "object",
                ...
                "resources": {
                    "type": "object",
                    "$ref": "#/definitions/setupcluster.meshDevResources"
                },
                "rollback": {
                    "type": "object",
                    "$ref": "#/definitions/setupcluster.rollback"
                }
            }
        },
        "setupcluster.MeshDevWorkload": {
            "type": "object",
            "properties": {
                "kind": {
                    "type": "string"
        ...
        "setupcluster.rollback": {
            "type": "object",
            "properties": {
                "header": {
                    "type": "object",
                    "$ref": "#/definitions/setupcluster.rollbackHeader"
                }
            }
        },
        "setupcluster.rollbackHeader": {
            "type": "object",
            "properties": {
                "add": {
                    "type": "object"
