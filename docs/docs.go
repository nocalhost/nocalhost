...
// 2021-04-13 19:26:57.800292913 +0800 CST m=+0.167315716
...
[{\"id\":1,\"context\":\"application info\",\"status\":\"1\"}]}",
		...
		"/v1/application/{id}": {
			...
			"delete": {
				"description": "The user deletes the application, 
and also deletes the configured development space in the application",
				"consumes": ["application/json"],
				"produces": ["application/json"],
				"tags": ["Application"],
...
status=0 application not installed, 1 installed",
		...
		"/v1/cluster/{id}/dev_space/{space_id}/detail": {
			"get": {
				"description": "Get cluster development environment details through cluster id and 
...
status=0 application not installed, 1 installed",
		...
		"/v1/version": {
			"get": {
				...
				"responses": {
					"200": {
						"description": "{\"code\":0,\"message\":\"OK\",\"data\":{\"version\":\"\",
\"commit_id\":\"\",\"branch\":\"\"}}",
						"schema": {
							"type": "string"
						}
	...
	"definitions": {
		...
		"model.ApplicationModel": {
			"type": "object",
			"required": ["context", "public", "status"],
			"properties": {
				"context": {
					"type": "string"
				},
		...
		"user.CreateUserRequest": {
			"type": "object",
			"required": ["confirm_password", "email", "is_admin", "name", "password", "status"],
			"properties": {
				"confirm_password": {
					"type": "string"
				},
