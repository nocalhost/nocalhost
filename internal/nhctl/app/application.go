...
const (
	...
	DefaultNocalhostApplicationOperateErr = "default.application is a virtual application to managed that those " +
		"manifest out of Nocalhost management so can't be install, uninstall, reset, etc."
