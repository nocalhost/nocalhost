...
const (
	...
	DefaultInitApplicationGithub  = "{\"source\":\"git\",\"install_type\":\"rawManifest\"," +
		"\"resource_dir\":[\"manifest/templates\"]," +
	...
	DefaultInitApplicationKustomize = "{\"source\":\"git\",\"install_type\":\"kustomize\"," +
		"\"application_name\":\"bookinfo-kustomize\"," +
		"\"application_url\":\"git@github.com:nocalhost/bookinfo.git\"," +
		"\"application_config_path\":\"config.kustomize.yaml\",\"resource_dir\":[]}"
	DefaultInitApplicationCODING = "{\"source\":\"git\",\"install_type\":\"rawManifest\"" +
		",\"resource_dir\":[\"manifest/templates\"]," +
