...
func (repo *applicationRepo) PublicSwitch(
	ctx context.Context,
...
func (repo *applicationRepo) GetByName(
	ctx context.Context,
	name string,
) (model.ApplicationModel, error) {
...
func (repo *applicationRepo) PluginGetList(
	ctx context.Context,
	userId uint64,
...
func (repo *applicationRepo) Create(
	ctx context.Context,
...
func (repo *applicationRepo) GetList(
	ctx context.Context,
	userId *uint64,
) ([]*model.ApplicationModel, error) {
...
func (repo *applicationRepo) Update(
	...
	affectRow := repo.db.Model(&application).
